...
public class BaseShape extends Transform implements Cloneable {
    ...
    public Collection<Point2d> cloneCoords() {
        return this.cloneCoords(this.coords);
    }
    ...
    public Double getMaxX() {
        return !coords.isEmpty() ? this.coords.stream().max(Comparator.comparing(Point2d::X)).get().X() : -Double.MAX_VALUE;
    }
    ...
    public Double getMaxY() {
        return !coords.isEmpty() ? this.coords.stream().max(Comparator.comparing(Point2d::Y)).get().Y() : -Double.MAX_VALUE;
    }
    ...
    public Double getMinX() {
        return !coords.isEmpty() ? this.coords.stream().min(Comparator.comparing(Point2d::X)).get().X() : Double.MAX_VALUE;
    }
    ...
    public Double getMinY() {
        return !coords.isEmpty() ? this.coords.stream().min(Comparator.comparing(Point2d::Y)).get().Y() : Double.MAX_VALUE;
    }
